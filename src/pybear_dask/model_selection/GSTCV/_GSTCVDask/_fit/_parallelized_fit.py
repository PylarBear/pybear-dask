...
def _parallelized_fit(
    ...
    **_fit_params
    ...
    _estimator:
        ClassifierProtocol - Any scikit-style classifier, having
        fit, predict_proba, get_params, and set_params methods (the
        score method is not necessary, as GSTCVDask never calls it.)
        This includes, but is not limited to, dask_ml, XGBoost dask, and
        LGBM dask classifiers.
    _grid:
